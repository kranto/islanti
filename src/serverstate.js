...
class ServerState {
  ...
  init() {
    ...
    console.log(this.getPlayerDeck(4, 3));
  }
  ...
  getPlayerDeck(playerCount, playerIndex) {
    return this.cards.map((card, index) => card.toPlayer((index % playerCount) == playerIndex && index < playerCount * 13));
  }
